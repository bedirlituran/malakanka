...
const allProducts = [
  ...
  // Peçenye
  { id: 16, name: "Ev Peçenyesi", weight: "400 q", price: "6.50", category: "Peçenye və şirniyyat", tag: "Şirniyyat", img: "https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=700&q=80" },
  { id: 17, name: "Badam Halvası", weight: "500 q", price: "9.00", category: "Peçenye və şirniyyat", tag: "Şirniyyat", img: "https://images.unsplash.com/photo-1548907040-4baa42d10919?auto=format&fit=crop&w=700&q=80" },
...
const categories = ["Hamısı", "Kolbasa və sosiska", "Pendir çeşidləri", "Süd məhsulları", "Bal və arıçılıq", "Turşu çeşidləri", "Peçenye və şirniyyat", "Hədiyyə setləri"];
...
<Navbar/>
      ...
      <div style={{ background: "#0F2419", padding: "64px 80px 56px", position: "relative", overflow: "hidden" }} className="prod-hero">
        ...
        <div style={{ maxWidth: "1400px", margin: "0 auto", position: "relative" }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "52px", fontWeight: 400, color: "#F5EFE4", margin: "0 0 12px", letterSpacing: "1px" }} className="prod-h1">Məhsullarımız</h1>
          <p style={{ fontSize: "15px", color: "rgba(245,239,228,0.5)", fontWeight: 300, maxWidth: "480px" }}>Kəndimizin ən təbii dadlarını süfrənizə çatdırırıq</p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "48px 80px 96px" }} className="prod-body">
        ...
        <div style={{ display: "flex", gap: "16px", marginBottom: "40px", flexWrap: "wrap", alignItems: "center" }} className="prod-toolbar">
          ...
          <div style={{ position: "relative", flex: "1", minWidth: "220px", maxWidth: "320px" }}>
            <svg style={{ position: "absolute", left: "13px", top: "50%", transform: "translateY(-50%)", color: "rgba(15,36,25,0.35)", pointerEvents: "none" }} width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
            ...
            <input
              ...
              style={{ width: "100%", padding: "10px 14px 10px 38px", borderRadius: "10px", border: "1px solid rgba(201,151,90,0.2)", background: "#fff", fontSize: "13px", color: "#0F2419", outline: "none", fontFamily: "'Inter', sans-serif", boxSizing: "border-box" }}
            />
          </div>
            ...
            <div key={product.id} className="prod-card">
              ...
              <div className="prod-body-inner">
                ...
                <div className="prod-footer">
                  ...
                  <a
                    href={`https://wa.me/994103140808?text=${encodeURIComponent(`Salam! "${product.name}" məhsulunu sifariş etmək istəyirəm.`)}`}
                    target="_blank"
