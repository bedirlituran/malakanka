    ...
    <section className="mk-categories">
      ...
      <style>{`
        ...
        .mk-cat-img-wrap {
          ...
          overflow: hidden;
          position: relative;
          border: 2px solid rgba(201,151,90,0.15);
          transition: border-color .3s, box-shadow .3s;
        }

        .mk-cat-item:hover .mk-cat-img-wrap {
          border-color: rgba(201,151,90,0.45);
          box-shadow: 0 12px 32px rgba(15,36,25,0.14);
        }
        ...
        .mk-cat-img-overlay {
          position: absolute;
          inset: 0;
          background: rgba(15,36,25,0);
          transition: background .3s;
        }

        .mk-cat-item:hover .mk-cat-img-overlay {
        ...
        .mk-cat-item:hover .mk-cat-bar {
          width: 40px;
          background: #C9975A;
        }

        @media (max-width: 1200px) {
          .mk-cat-grid { grid-template-columns: repeat(4, 1fr); gap: 24px; }
          .mk-categories { padding: 60px 40px; }
        }

        @media (max-width: 768px) {
          .mk-cat-grid { grid-template-columns: repeat(3, 1fr); gap: 20px; }
          .mk-categories { padding: 48px 24px; }
          .mk-cat-img-wrap { width: 100px; height: 100px; }
          .mk-cat-title { font-size: 28px; }
        }

        @media (max-width: 480px) {
          .mk-cat-grid { grid-template-columns: repeat(2, 1fr); gap: 16px; }
          .mk-categories { padding: 40px 16px; }
          .mk-cat-img-wrap { width: 90px; height: 90px; }
          .mk-cat-name { font-size: 12px; }
        }
      `}</style>
    </section>
  );
