...
const Footer = () => {
  const navLinks = ["Ana səhifə", "Məhsullar", "Haqqımızda", "Çatdırılma", "Əlaqə"];
  const categories = [
    "Kolbasa və sosiska",
    "Pendir çeşidləri",
    "Süd məhsulları",
    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div style={{ marginTop: "24px", display: "flex", flexDirection: "column", gap: "12px" }}>
              {[
                { icon: "M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z", text: "+994 10 314 08 08" },
                { icon: "M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4", text: "50 AZN-dən yuxarı pulsuz çatdırılma" },
              ].map((item, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "13px", color: "rgba(245,239,228,0.65)" }}>
                  <span
                    style={{
                      width: "30px",
                      height: "30px",
              ...
              {navLinks.map((item) => (
                <li key={item} style={{ marginBottom: "14px" }}>
                  <a
                    ...
                    // onMouseEnter={(e) => (e.target.style.color = "#C9975A")}
          ...
          <div>
            ...
            >
              ...
              <a
                ...
                // onMouseEnter={(e) => (e.target.style.color = "#F5EFE4")}
                // onMouseLeave={(e) => (e.target.style.color = "#C9975A")}
              >
                +994 10 314 08 08
              </a>
            </div>
        ...
        <div style={{ marginTop: "56px" }}>
          ...
          >
            <p style={{ fontSize: "12px", color: "rgba(245,239,228,0.3)", letterSpacing: "0.5px" }}>
